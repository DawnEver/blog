...
############################################################################
# 对象
set user:1 {name:bennett,age:20} # 设置user为一个对象
# or
set user:1:name bennett
# user:{id}:{filed} value
...
![查看源图像](http://cdn.bennett.cn/blogR50ea35ec36a3e4ea16cb132637477df0)
...
![img](http://cdn.bennett.cn/blog11320039-57a77ca2757d0924.png)
