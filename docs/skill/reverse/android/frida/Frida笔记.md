...
```sh
adb push C:\Users\bennett\Desktop\frida-server-15.1.14-android-arm64 /data/local/tmp/fsarm64
...
let Utils = Java.use('com.bennett.app.Utils')
```
...
```javascript
const Utils = Java.use('com.bennett.app.Utils')
...
var Person = Java.use('com.bennett.app.Person')
var person = Person.$new('bennett', 20)
...
```
adb push C:\Users\bennett\Desktop\frida-inject-15.1.14-android-arm64 /data/local/tmp/fiarm64
